...
config :img_to_txt, ImgToTxtWeb.Endpoint,
  ...
  pubsub: [name: ImgToTxt.PubSub, adapter: Phoenix.PubSub.PG2]
...
config :img_to_txt,
       :cognitive_api_url,
       System.get_env("AZURE_API_URL") ||
         "https://eastus.api.cognitive.microsoft.com/contentmoderator/moderate/v1.0/ProcessImage/OCR?language=eng&CacheImage=true&enhanced=false"
